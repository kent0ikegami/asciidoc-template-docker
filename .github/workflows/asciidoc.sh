...
asciidoctor-pdf -a pdf-theme=./resource/themes/default-theme.yml -a pdf-fontsdir=./resource/fonts -a source-highlighter=pygments -r ./src/resource/patch-prawn.rb -D ./dist/ -o index.pdf -a scripts@=cjk -r asciidoctor-diagram ./src/index.adoc
